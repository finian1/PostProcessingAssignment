...
bool InitDirect3D()
{
    ...
    UINT flags = 0/*D3D11_CREATE_DEVICE_DEBUG*/; // Set this to 0, or D3D11_CREATE_DEVICE_DEBUG to get more debugging information (in the "Output" window of Visual Studio)
